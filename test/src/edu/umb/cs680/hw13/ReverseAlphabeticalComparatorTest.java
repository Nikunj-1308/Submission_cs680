...
public class ReverseAlphabeticalComparatorTest
{
    ...
    public void verifyGetChildrenRepoAsTestSrcReadme() {
        ...
        Directory dir = repo;
        List<FSElement> element = dir.getChildren(new ReverseAlphabeticalComparator());
    ...
    public void verifyGetSubDirectoriesForRepoAsTestSrc() {
        ...
        Directory dir = repo;
        List<Directory> element = dir.getSubDirectories(new ReverseAlphabeticalComparator());
        Assertions.assertArrayEquals(expected, element.toArray());
    }
    ...
    public void verifyGetFilesForSrcAsBAndA() {
        File[] expected = {b, a};
        Directory dir = src;
        List<File> element = dir.getFiles(new ReverseAlphabeticalComparator());
        Assertions.assertArrayEquals(expected, element.toArray());
    }
