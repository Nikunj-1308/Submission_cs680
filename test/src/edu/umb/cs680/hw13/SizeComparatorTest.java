...
public class SizeComparatorTest
{
    ...
    public void verifyGetChildrenForRepoAsReadmeSrcTest() {
        ...
        Directory dir = repo;
        List<FSElement> element = dir.getChildren(new SizeComparator());
    ...
    public void verifyGetSubDirectoriesForRepoAsSrcTest() {
        ...
        Directory dir = repo;
        List<Directory> element = dir.getSubDirectories(new SizeComparator());
        assertArrayEquals(expected,element.toArray() );
    }
    ...
    public void verifyGetFilesForSrcTestAsATestBTest() {
        ...
        List<File> element = dir.getFiles(new SizeComparator());
        assertArrayEquals(expected,element.toArray());
    }
}